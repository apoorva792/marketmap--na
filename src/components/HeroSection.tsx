  ...
  return (
    <section className="pt-10 sm:pt-16 lg:pt-20 pb-6 px-5 sm:px-10 lg:px-16">
      <div className="max-w-[1180px] mx-auto">
        ...
        <div className="text-center flex flex-col items-center">
          ...
          >
            <span style={{
              ...
              2026 Agentic AI Services Map &middot; North America
            </span>
          </div>
        ...
        >
          <span><strong style={{ color: "#2A1F1A", fontWeight: 700 }}>24</strong> Firms</span>
          <span style={{ color: "#C96A5A" }}>&middot;</span>
          <span><strong style={{ color: "#2A1F1A", fontWeight: 700 }}>5</strong> Capabilities</span>
          <span style={{ color: "#C96A5A" }}>&middot;</span>
          <span><strong style={{ color: "#2A1F1A", fontWeight: 700 }}>6</strong> Verticals</span>
        </div>
      </div>
    </section>
  );
