...
const SHARE_MESSAGE =
  "Recognised as an Agentic AI Services Leader on the Lyzr 2026 Agentic AI Services Map — North America, among the mid-market services firms shipping agentic AI in production.\n\n" +
  "Lyzr powers production AI agents across 100+ enterprises. Being named among North America's agentic AI services leaders in 2026 reflects the work our team puts into getting AI past the pilot and into production for our clients.\n\n" +
...
function drawBadgeCanvas(
  ...
  return new Promise((resolve) => {
    ...
    function drawBody() {
      ...
      ctx.fillText("North America · 2026 Map", w / 2, py + 192);
